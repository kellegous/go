...
func createTableIfNotExist(db *sql.DB) error {
	...
	queryString := "CREATE TABLE IF NOT EXISTS linkdata (URL varchar(500) NOT NULL, Time date NOT NULL, Uid NUMERIC PRIMARY KEY, Generated boolean NOT NULL, Name varchar(100) NOT NULL)"
